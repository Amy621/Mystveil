...
public class PauseMenu : MonoBehaviour
{
    ...
    public GameObject controlsUI; // New UI panel for controls
    public Image controlsImage; // Reference to the controls image
    ...
    private void Start()
    {
        // Make sure controls UI is initially hidden
        if (controlsUI != null)
        {
    ...
    private void Update()
    {
        ...
        // Check for mouse click outside controls image
        if (controlsUI != null && controlsUI.activeSelf && Input.GetMouseButtonDown(0))
        {
            // Check if the click was outside the controls image
            if (!IsPointerOverUIElement(controlsImage.gameObject))
            {
    ...
    public void ShowControls()
    {
        if (controlsUI != null)
        {
            ...
            // Don't hide the pause menu UI, just move it behind the controls
            pauseMenuUI.SetActive(true);
        }
    }
    ...
    public void ReturnToPauseMenu()
    {
        ...
        {
            controlsUI.SetActive(false);
            // Pause menu should already be visible
        }
    }
